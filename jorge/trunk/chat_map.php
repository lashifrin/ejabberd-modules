	...
	if ($peer_name_id !== null AND $peer_server_id !== null) {
		...
		foreach ($result1 as $row_m) {
			...
			if (count($days)>=1) {
					...
					$html->set_body(calendar($db,$user_id,$xmpp_host,$y,$m,$days,TOKEN,$url_key,$months_name_eng,$left,$right,$selected,$lang,$view_type,2,$peer_name_id,$peer_server_id,$cal_days,$enc));
